...
export default function Programcilar() {
  ...
  const [programcilarId, setProgramcilarId] = useState(null);

  const oneCikaninIsmi = () => {
    return programcilar[programcilarId - 1].isim;
    // Bunu sona bırakın!
  ...
  const stil = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: programcilarId == null ? "royalblue" : "gold", // 🤔 kutlarken renk gold'a dönecek
  };
